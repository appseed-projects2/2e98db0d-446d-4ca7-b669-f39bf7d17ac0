...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-19 10:43`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/2e98db0d-446d-4ca7-b669-f39bf7d17ac0.git
$ cd 2e98db0d-446d-4ca7-b669-f39bf7d17ac0
```
